import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-Cdal7T4f.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CdrH2JP3.mjs");
