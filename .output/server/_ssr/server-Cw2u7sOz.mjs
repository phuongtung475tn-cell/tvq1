import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-hZzAbtud.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B0IfGvnX.mjs");
