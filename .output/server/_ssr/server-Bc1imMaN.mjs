import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-SwdlihR5.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DYfW0E_E.mjs");
